...
public class politicsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvPolitics = view.findViewById(R.id.rvPolitics);
        modelclassArrayList = new ArrayList<>();
        rvPolitics.setLayoutManager(new LinearLayoutManager(getContext()));
    ...
    private void findNews() {
        ...
        ApiUtiliti.getApiInterface().getcategoryNews("in", "politics",100, api).enqueue(new Callback<Articalclass>() {
            @Override
